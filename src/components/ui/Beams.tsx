...
const DirLight: FC<{ position: [number, number, number]; color: string }> = ({
  ...
  useEffect(() => {
    ...
    (cam as unknown as { top: number; bottom: number; left: number; right: number; far: number }).top = 24;
    (cam as unknown as { top: number; bottom: number; left: number; right: number; far: number }).bottom = -24;
    (cam as unknown as { top: number; bottom: number; left: number; right: number; far: number }).left = -24;
    (cam as unknown as { top: number; bottom: number; left: number; right: number; far: number }).right = 24;
    (cam as unknown as { top: number; bottom: number; left: number; right: number; far: number }).far = 64;
